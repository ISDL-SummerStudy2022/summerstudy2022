...
type Props = {
  ...
  onAdd: (text: string, genre: string, priority: number) => void;
  genre: string;
...
export const TodoInput: VFC<Props> = memo((props) => {
  const { text, setText, typing, setTyping, onAdd, genre, setGenre, priority, setPriority } = props;
